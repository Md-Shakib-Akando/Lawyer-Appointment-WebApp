    ...
    return (
        <>
            <div className=' my-5 md:mb-10 md:mt-10 py-5 px-5 md:px-10 border border-[#0F0F0F20] rounded-xl '>
                            ...
                            <button  className="relative w-full mb-4 cursor-pointer items-center justify-center inline-block px-5 py-3 overflow-hidden font-medium transition-all bg-white rounded-full hover:bg-[#FF0000] group">
